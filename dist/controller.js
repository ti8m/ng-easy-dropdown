...
var EasyDropdownController = function () {
  function EasyDropdownController($document) {
    _classCallCheck(this, EasyDropdownController);
  ...
  _createClass(EasyDropdownController, [{
    key: 'init',
    value: function init(domNode, settings) {
      var self = this;
    ...
    value: function getMaxHeight() {
      ...
      for (var _i = 0; _i < self.$items.length; _i++) {
        this.i = _i;
        var $item = self.$items.eq(_i);
...
exports.default = EasyDropdownController;